    ...
    <div className={classes.root}>
      <ExpantionPanel>
        ...
        >
          <Tooltip title="編集">
            <IconButton
              area-label="Edit group"
              onClick={() => {
                onUpdateChoiceDialogOpen(choiceGroup.groupId);
              }}
            >
              <EditIcon />
            </IconButton>
          ...
          <Tooltip title="削除">
            <IconButton
              area-label="Delete group"
              onClick={() => {
                onRemoveChoiceDialogOpen(choiceGroup.groupId);
              }}
            >
              <DeleteIcon />
            </IconButton>
          ...
          <ul className={classes.optionList}>
            {choiceGroup.choiceOptions.map((option) => (
              <li key={option.choiceId}>
                <Typography>{option.choiceName}</Typography>
              </li>
            ))}
          </ul>
        </ExpantionPanelDetails>
